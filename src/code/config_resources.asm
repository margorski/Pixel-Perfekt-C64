...
* = address_sprites                  
!bin "resources/sprites.raw",1024,3  	 ; skip first three bytes which is encoded Color Information
...
* = address_chars                     
!bin "resources/charset.bin",384,0   ; skip first 24 bytes which is CharPad format information 
